<template>
  ...
  <el-form-item label="分类图片" prop="image" >
    <el-switch
      ...
      <el-input v-model="formData.icon" v-show="formData.uploadType"  placeholder="请输入内容" ></el-input>
      <uploadImg v-model="formData.icon" v-show="!formData.uploadType"></uploadImg>
  </el-form-item>
